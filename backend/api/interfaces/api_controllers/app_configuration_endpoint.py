...
async def get_app_configuration(
    ...
    if current_user is not None:
        ...
        user_pref_doc = (
            await user_preferences.to_serializable_dict()
        ...
        if user_pref_doc is not None:
            user_pref_doc.setdefault("preferences", {})[
                "passkey_enabled"
            ] = passkey_enabled
    ...
    enabled_sso_provider_names = [
        str(sso.provider) for sso in enabled_sso_provider.items
    ]
