...
@router.get(
    "/{sso_id}", response_model=ReadSSOSettingsDto, response_model_exclude_none=True
)
...
@router.post(
    "/", response_model=SSOSettingsResponseDto, status_code=status.HTTP_201_CREATED
)
