from api.domain.dtos.stripe_setting_dto import (
    CreateStripeSettingDto,
    StripeSettingDto,
    StripeSettingSecretDto,
)
...
class StripeSettingService:
    ...
    async def configure_stripe_settings(
        self, settings: CreateStripeSettingDto, tenant_id: str
    ) -> None:
        """
